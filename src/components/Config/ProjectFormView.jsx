...
import { FolderIcon, AlertIcon, CloseIcon } from "../Launcher/Icons";

export function ProjectFormView({ initialData = null, onCancel, onSuccess }) {
  ...
  const {
    ...
    handleBrowseFolder,
    handleSave,
  } = useProjectForm({ initialData, onSuccess });
...
export const AddProjectView = ProjectFormView;
